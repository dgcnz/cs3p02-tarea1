...
def main():
    ...
    parser_monitor.add_argument("max_cpu_usage", type=float, help="Max CPU usage.")
    parser_monitor.add_argument(
        "max_vm_usage", type=float, help="Max virtual memory usage."
    )

    parser_monitor.add_argument(
        "time_threshold", type=float, help="Time under max load."
    )
